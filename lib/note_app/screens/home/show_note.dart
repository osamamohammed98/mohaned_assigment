...
class ShowNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bodyController.text = noteData!.body.toString();
    var formattedDate =
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () {
            if (titleController.text != noteData!.title.toString() ||
                bodyController.text != noteData!.body.toString()) {
              Database().updateNote(authController.user!.uid,
                  titleController.text, bodyController.text, noteData!.id.toString());
              Get.back();
