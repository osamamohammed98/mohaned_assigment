...
import 'package:mohaned_assigment/note_app/screens/home/show_note.dart';
                ...
                children: [
                  ListTile(
                    ...
                    title: Padding(
                      ...
                      child: Text(
                        noteController.notes[index].title.toString(),
                        maxLines: 1,
                    ...
                    subtitle: Text(
                      noteController.notes[index].body.toString(),
                      maxLines: 10,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                        fontSize: 14,
